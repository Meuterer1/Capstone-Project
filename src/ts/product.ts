...
const contentNameDetails = document.getElementById("content-name-details");
if (contentNameDetails) {
  let items: Product[] = [];
  const contentNameDetailsEl = contentNameDetails as HTMLHeadingElement;
  const contentNameReviews = document.getElementById(
    "content-name-reviews",
  ) as HTMLHeadingElement;
  const contentNameShipping = document.getElementById(
    "content-name-shipping",
  ) as HTMLHeadingElement;
  const contentDetails = document.getElementById(
    "content-details",
  ) as HTMLDivElement;
  ...
  contentNameDetailsEl.addEventListener("click", () => {
  ...
  contentNameShipping.addEventListener("click", () => {
    ...
    contentDetails.textContent =
      "We offer free standard shipping on all orders within the continental United States. Expedited shipping options are available at checkout for an additional fee. International shipping is also available, with rates calculated at checkout based on destination.";
  });
  ...
  function generateProductCart(product: Product) {
    const productCartName = document.getElementById(
      "product-cart-name",
    ) as HTMLHeadingElement;
    const productCartStars = document.getElementById(
      "product-cart-stars",
    ) as HTMLDivElement;
    const productCartPrice = document.getElementById(
      "product-cart-price",
    ) as HTMLHeadingElement;
    const productCartDescription = document.getElementById(
  ...
  function generateYouMayAlsoLike() {
    const youMayAlsoLike = document.getElementById(
    ...
    randomItems.forEach((item) => {
      ...
      productCard.addEventListener("click", (e) => {
        ...
        window.location.href = `/html/product-details.html?id=${item.id}`;
      });
  ...
  function handleReviewSubmit(e: Event) {
    ...
    const reviewText =
      form.querySelector<HTMLTextAreaElement>("textarea[name='review']")
        ?.value || "";
